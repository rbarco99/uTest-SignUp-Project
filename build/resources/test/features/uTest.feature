...
Feature: uTest user registration
  As a new user, I want to to register in the uTest webpage
  @scenario1
  Scenario: A new user correctly register in uTest
    ...
    When the user provides the required data in each step
      ...
      | <random name> | <random lastname> | <random email> | June          | 14          | 1999         | Neiva   | 140414 | Colombia   | Windows       | Windows 10   | Spanish       | Apple          | Iphone X       | iOS 12.0    | 99Secur3.test|
